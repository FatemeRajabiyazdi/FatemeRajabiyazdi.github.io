...
WaitingTimeInfo.prototype.GetFiftyWeek = function () {
	if (this.fiftyWeek === -1)
		return "NA";
	else
		return this.fiftyWeek;
}

WaitingTimeInfo.prototype.GetNinetyWeek = function () {
	if (this.ninetyWeek === 2.5)
		return "-1";
	else
		return this.ninetyWeek;
}
