...
var BCMap = (function () {
	...
	BCMap.prototype.DrawArcs = function (animate) {
		...
		var tip = d3.tip()
					...
					.offset([-10, 0])
					.html(function (d) {
						return "<span style='color:white; line-height: 150%;'>" + d.hospital.Name + "<br/>Cases Waiting: " + d.WaitingTable.GetWaitingTime() + "<br/> 50% Recieved (weeks): " + d.WaitingTable.fiftyWeek + "<br/> 90% Recieved (weeks): " + d.WaitingTable.ninetyWeek + "</span>";
					});
